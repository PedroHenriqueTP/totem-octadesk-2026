...
export const AdminPanel: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handleExportCSV = async () => {
    ...
    const headers = [
      ...
      "tamanhoOperacao",
      "totalFerramentas",
      "possuiCarrinhoAbandonado",
      "possuiIaVendas",
      "possuiNotificacaoStatus",
      "possuiIaDuvidasStatus",
      "possuiEmissaoNotas",
      "possuiHelpdeskSla",
      "perfil_bifurcado",
      "sincronizado",
    ...
    const rows = allLeads.map((l) =>
      [
        ...
        l.tamanhoOperacao ?? "",
        l.totalFerramentas ?? "",
        l.possuiCarrinhoAbandonado ? "Sim" : "Não",
        l.possuiIaVendas ? "Sim" : "Não",
        l.possuiNotificacaoStatus ? "Sim" : "Não",
        l.possuiIaDuvidasStatus ? "Sim" : "Não",
        l.possuiEmissaoNotas ? "Sim" : "Não",
        l.possuiHelpdeskSla ? "Sim" : "Não",
        l.perfil_bifurcado ?? "",
        l.sincronizado ?? 0,
        l.criado_em ?? "",
      ]
      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-[#E2E8F0] pb-6 mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-550 text-sm">Monitoramento de Infraestrutura de Dados Offline-First | Fórum E-commerce Brasil 2026</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className={`border p-6 rounded-2xl transition-all shadow-sm ${
            ...
            <h3 className={`text-4xl font-black ${metrics.pendentesOffline > 0 ? "text-amber-650" : "text-slate-900"}`}>
